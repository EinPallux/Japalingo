...
| Future | Content-gated | ~~Vocabulary~~ (**shipped** — JLPT N5, from `/database`), kanji, grammar, sentences/listening, recorded audio, accounts + cloud sync + leagues/friends, PWA polish. Build ONLY when `/database` grows. |
