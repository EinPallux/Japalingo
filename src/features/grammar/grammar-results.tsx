    ...
    <main id="main" className="grid min-h-dvh place-items-center px-5 py-10">
      ...
      >
        ...
        <motion.div variants={pop}>
          <h1 className="font-display text-3xl font-bold text-ink">Chapter {chapter.num} complete! 🎉</h1>
        ...
        <div className="grid w-full grid-cols-2 gap-3">
          ...
          <motion.div variants={pop} className="rounded-blob-lg border border-border bg-primary-tint p-4">
            <p className="font-display text-3xl font-bold text-primary">{chapter.points.length}</p>
            <p className="text-sm font-semibold text-muted">points learned</p>
          </motion.div>
        </div>
